...
#import "URCreatQRCodeBarcode.h"

@implementation URCreatQRCodeBarcode
...
+ (UIImage *)urCreatBarCodeWithString:(NSString *)string
    ...
    NSData *data = [string dataUsingEncoding:NSISOLatin1StringEncoding allowLossyConversion:false];
