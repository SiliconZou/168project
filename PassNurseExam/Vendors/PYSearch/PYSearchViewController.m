...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        UITableView *baseSearchTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, URSafeAreaNavHeight(), URScreenWidth(), URScreenHeight()-URSafeAreaNavHeight()) style:UITableViewStyleGrouped];
...
- (UIButton *)emptyButton
{
    if (!_emptyButton) {
        ...
        [emptyButton setTitle:@"清空记录" forState:UIControlStateNormal];
...
//
    ...
    UIView *titleView = [[UIView alloc] initWithFrame:CGRectMake(43 * AUTO_WIDTH,URSafeAreaStateHeight() + 7 , 280 * AUTO_WIDTH, 30)];
    UISearchBar *searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0,0, 280 * AUTO_WIDTH, 30)];
...
//    self.navigationItem.titleView = titleView;
    [self.cViewNav addSubview:titleView];
    ...
    emptySearchHistoryLabel.text = @"清空记录";
