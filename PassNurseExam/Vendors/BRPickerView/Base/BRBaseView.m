...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.frame = CGRectMake(5, 12, 60, 24);
        _leftBtn.backgroundColor = [UIColor  whiteColor];
        _leftBtn.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleRightMargin;
        _leftBtn.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:17.0f * kScaleFit];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.frame = CGRectMake(self.alertView.frame.size.width - 65, 12, 60, 24);
        _rightBtn.backgroundColor = [UIColor  whiteColor];
        _rightBtn.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleLeftMargin;
        _rightBtn.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:17.0f * kScaleFit];
        [_rightBtn setTitleColor:BR_RGB_HEX(0x005198, 1.0) forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = RegularFont(16.0f * kScaleFit);
        _titleLabel.textColor = BR_RGB_HEX(0X333333, 1.0);
