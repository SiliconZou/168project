...
- (void)configDataSource:(id)dataSource defaultSelValue:(id)defaultSelValue {
    ...
    NSArray *dataArr = nil;
    if ([dataSource isKindOfClass:[NSArray class]] && [(NSMutableArray *)dataSource count] > 0) {
    ...
    if (self.type == BRStringPickerComponentSingle) {
        ...
        for (NSInteger i = 0; i < self.dataSourceArr.count; i++) {
            ...
            if (defaultSelValue && [defaultSelValue isKindOfClass:[NSArray class]] && [(NSMutableArray *)defaultSelValue count] > 0 && i < [(NSMutableArray *)defaultSelValue count] && [self.dataSourceArr[i] containsObject:defaultSelValue[i]]) {
...
- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component {
    switch (self.type) {
        case BRStringPickerComponentSingle:
            ...
            break;
        case BRStringPickerComponentMore:
            return [(NSMutableArray *)self.dataSourceArr[component] count];
            break;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view {
    ...
    label.font = RegularFont(22.0f * kScaleFit);
    // 字体自适应属性
